...
$report_options = '';
$filtervalues = '';
$filternames = 'Customer|jobtitle|jobtype|department|modified_date';
$filtervalues = $TricomJobOrder;
if (isset($view) && $view == 'myreport' && isset($id) && !empty($id)) {
    ...
    if (session_is_registered('TricomJobOrder')) {
        session_unregister('TricomJobOrder');
        unset($TricomJobOrder);
    }  
   $filtervalues   = $TricomJobOrder;
}
?>
<html>
                ...
                document.getElementById('Customer').addEventListener('keypress', function(event) {
                 ...
                 runReport = function (format){
                    ...
                    {   
                        ...
                        $("#TricomJobOrder").attr("target", "TricomJobOrderReport").submit();
                    ...
                    else if (window.opener.location.href.indexOf("BSOS/Analytics/Reports/TricomJobOrder/header.php") > 0) 
                    {   
                        $("#TricomJobOrder").attr("target", "TricomJobOrderReportWindow").submit();
                    }
    ...
    <body>
        <form name="TricomJobOrder" id="TricomJobOrder" action="storereport.php" method="post">
