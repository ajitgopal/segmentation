...
*/	
	...
	if($main=="main")
		...
		$Analytics_HrmEmployeesAdpNew = $Analytics_HrmEmployeesAdpNew;	
...
//	echo "</pre>";
	...
	$tab = $rdata[18]; // THIS VALUE IS SET TO "addr" BY DEFAULT IN hrreportfunctions.php
...
//	echo "this \$filternames:$filternames<br />";
//	echo "this \$filtervalues:$filtervalues<br />";
	...
	$rcount = 63; //Need to Change the count when new column is added -Important
...

	{
		...
		$checkDateFilter = "checked";

		$checkTimesheetDate = "checked";
		...
		$maintitle="Employees Adp Report";
...
<form name="form1" action="employeesreport.php" method="post">
	...
	<tr>
        ...
        <script type="text/javascript">tp2 = new WebFXTabPane( document.getElementById( "tabPane1" ) );</script>
			...
			<h2 class="tab">Report</h2>
				...
				<div style="display:none">
                <?php require("viewcolumn.php"); require("viewfonts.php"); require("viewheader.php"); require("viewformat.php"); require("viewsort.php"); require("viewcolsort.php");?>
