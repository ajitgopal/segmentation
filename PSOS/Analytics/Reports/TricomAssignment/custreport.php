...
$report_options = '';
$filtervalues = '';
$filternames = 'jobtitle|assignmentid|department|modifieddate';
$filtervalues = $TricomAssignment;
if (isset($view) && $view == 'myreport' && isset($id) && !empty($id)) {
    ...
    if (session_is_registered('TricomAssignment')) {
        session_unregister('TricomAssignment');
        unset($TricomAssignment);
    }  
   $filtervalues   = $TricomAssignment;
}
?>
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            function assignmentsWindow(fieldname)
            {
                ...
                url = "/BSOS/Analytics/SearchWindows/commonSearch.php?fieldname=assignmentid&dbInstance=hrcon_jobs^pusername&modulename="+modulename;
                ...
                document.getElementById('jobtitle').addEventListener('keypress', function(event) {
                 ...
                 runReport = function (format){
                    ...
                    {   
                        ...
                        $("#TricomAssignment").attr("target", "TricomAssignmentReport").submit();
                    ...
                    else if (window.opener.location.href.indexOf("BSOS/Analytics/Reports/TricomAssignment/header.php") > 0) 
                    {   
                        $("#TricomAssignment").attr("target", "TricomAssignmentReportWindow").submit();
                    }
    ...
    <body>
        <form name="TricomAssignment" id="TricomAssignment" action="storereport.php" method="post">
