<?php 
	...
	*/	
    ...
    $fieldnames = array("empBranchLocation"=>"HRM Location","empstatus" =>"Status","empCompanyCode" =>"Company Code","empdept" => "Department");			//"empWithholdTaxState"=>"Withholding Tax State", removed (duplicate) Piyush R
	...
	{	
			...
			$entirefields_array =   array("empBranchLocation","empCompanyCode","empstatus","empdept");//"empWithholdTaxState", removed (duplicate) Piyush R
			 ...
			 if(in_array($entirefields_array[$i],$filternames_array))
...

				 {
				  ...
				  $showFilter .=  "<font class='afontstyle'>
						...
						<img class='remind-delete-align' src=/BSOS/images/reset.gif width='17' height='16' alt='Reset' 
