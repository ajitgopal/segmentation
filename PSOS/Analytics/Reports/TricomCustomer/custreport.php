...
$report_options = '';
$filtervalues = '';
$filternames = 'department|Customer|modifieddate';
$filtervalues = $TricomCustomer;
if (isset($view) && $view == 'myreport' && isset($id) && !empty($id)) {
    ...
    if (session_is_registered('TricomCustomer')) {
        session_unregister('TricomCustomer');
        unset($TricomCustomer);
    }  
   $filtervalues   = $TricomCustomer;
}
?>
<html>
    <head>
        ...
        <link type="text/css" rel="stylesheet" href="/BSOS/css/zebra_datepicker.min.css">
         <!-- <link type="text/css" rel="stylesheet" href="/BSOS/css/zebra_datepicker.css">
         <link type="text/css" rel="stylesheet" href="/BSOS/css/zebra_datepicker.scss"> -->
        ...
        <script type="text/javascript">
            ...
            {
                var modulename = "CustomerXmlReport";
            ...
            $(document).ready(function() {
                ...
                document.getElementById('Customer').addEventListener('keypress', function(event) {
                    if (event.keyCode == 13) {
                 ...
                 runReport = function (format){
                    ...
                    {   
                        ...
                        $("#TricomCustomer").attr("target", "TricomCustomerReport").submit();
                    ...
                    else if (window.opener.location.href.indexOf("BSOS/Analytics/Reports/TricomCustomer/header.php") > 0) 
                    {   
                        $("#TricomCustomer").attr("target", "TricomCustomerReportWindow").submit();
                    }
    ...
    <body>
        <form name="TricomCustomer" id="TricomCustomer" action="storereport.php" method="post">
