...
*/	
	...
	if($main=="main")
		...
		$Analytics_HrmEmployeesAdp=$Analytics_HrmEmployeesAdp;	
...

	{
		...
		if($reportfrm==2)//If the report   opend from Deduction Report

		 {
			...
			//$filternames ="empFein^empid^empssn^emplname^empAbaAcc1^empAccnumberAcc1^empAccTypeAcc1^empBanknameAcc1^empAbaAcc2^empAccnumberAcc2^empAccTypeAcc2^empBanknameAcc2^empClass^empVeterans";
			
			$filternames = "empBranchLocation^empstatus^empCompanyCode^empdept";
		...
		//	$colchk5="checked";
			...
			//$filternames ="empBranchLocation^empVeterans";
