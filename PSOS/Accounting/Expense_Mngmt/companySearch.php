<?php 
	...
	$sqlStaff = "select sc.sno, sc.cname,sc.address1,sc.address2,sc.city,sc.state from staffacc_cinfo sc LEFT JOIN Client_Accounts ON (Client_Accounts.typeid=sc.sno) where {$condition} {$accesscond} AND Client_Accounts.deptid !='0' AND Client_Accounts.deptid IN(".$deptAccesSno_BO.") group by sc.sno order by sc.cname";
...
<table width=99% cellpadding=1 cellspacing=1 class="ProfileNewUI" align="center">
   <tr>
	   ...
	   <font> Search for Customers</font></td>
   </tr>
   <tr>
	...
	<a href="companySearch.php?letter=a&<?= $appendurl?>"> <i class="fa fa-reply"></i></a></td>
   </tr>
   
<tr>
   <td class="joborderSerchList" colspan="2"> &nbsp;&nbsp;&nbsp;
   <a href="companySearch.php?letter=a&<?= $appendurl?>" class="alphabetStyle">A</a>&nbsp;
   <a href="companySearch.php?letter=b&<?= $appendurl?>" class="alphabetStyle">B</a>&nbsp;
   <a href="companySearch.php?letter=c&<?= $appendurl?>" class="alphabetStyle">C</a>&nbsp;
   <a href="companySearch.php?letter=d&<?= $appendurl?>" class="alphabetStyle">D</a>&nbsp;
   <a href="companySearch.php?letter=e&<?= $appendurl?>" class="alphabetStyle">E</a>&nbsp;
   <a href="companySearch.php?letter=f&<?= $appendurl?>" class="alphabetStyle">F</a>&nbsp;
   <a href="companySearch.php?letter=g&<?= $appendurl?>" class="alphabetStyle">G</a>&nbsp;
   <a href="companySearch.php?letter=h&<?= $appendurl?>" class="alphabetStyle">H</a>&nbsp;
   <a href="companySearch.php?letter=i&<?= $appendurl?>" class="alphabetStyle">I</a>&nbsp;
   <a href="companySearch.php?letter=j&<?= $appendurl?>" class="alphabetStyle">J</a>&nbsp;
   <a href="companySearch.php?letter=k&<?= $appendurl?>" class="alphabetStyle">K</a>&nbsp;
   <a href="companySearch.php?letter=l&<?= $appendurl?>" class="alphabetStyle">L</a>&nbsp;
   <a href="companySearch.php?letter=m&<?= $appendurl?>" class="alphabetStyle">M</a>&nbsp;
   <a href="companySearch.php?letter=n&<?= $appendurl?>" class="alphabetStyle">N</a>&nbsp;
   <a href="companySearch.php?letter=o&<?= $appendurl?>" class="alphabetStyle">O</a>&nbsp;
   <a href="companySearch.php?letter=p&<?= $appendurl?>" class="alphabetStyle">P</a>&nbsp;
   <a href="companySearch.php?letter=q&<?= $appendurl?>" class="alphabetStyle">Q</a>&nbsp;
   <a href="companySearch.php?letter=r&<?= $appendurl?>" class="alphabetStyle">R</a>&nbsp;
   <a href="companySearch.php?letter=s&<?= $appendurl?>" class="alphabetStyle">S</a>&nbsp;
   <a href="companySearch.php?letter=t&<?= $appendurl?>" class="alphabetStyle">T</a>&nbsp;
   <a href="companySearch.php?letter=u&<?= $appendurl?>" class="alphabetStyle">U</a>&nbsp;
   <a href="companySearch.php?letter=v&<?= $appendurl?>" class="alphabetStyle">V</a>&nbsp;
   <a href="companySearch.php?letter=w&<?= $appendurl?>" class="alphabetStyle">W</a>&nbsp;
   <a href="companySearch.php?letter=x&<?= $appendurl?>" class="alphabetStyle">X</a>&nbsp;
   <a href="companySearch.php?letter=y&<?= $appendurl?>" class="alphabetStyle">Y</a>&nbsp;
   <a href="companySearch.php?letter=z&<?= $appendurl?>" class="alphabetStyle">Z</a>&nbsp;&nbsp;&nbsp;
   <a href="companySearch.php?letter=others&<?= $appendurl?>" class="alphabetStyle">other</a>
   </td>   
</tr>
 ...
 <tr>
	...
	?>
		...
		<td  height="22" onclick="javascript : <?= (isset($ssearch) && $ssearch=='custexp') ? 'custexpensetyp(\''.$row['sno'].'\');' : 'displaycustValue(\''.$row['sno'].'\', \''.$row['cname'].'\');'?>" class="RowBoarder">
		<strong><?= html_tls_specialchars($row['cname']); ?></strong> <?=  $address ?> <?php echo " - ".$row['sno']; ?></td>
		</tr>
		<tr nowrap="nowrap">
