...
$report_options = '';
$filtervalues = '';
$filternames = 'empname|emp_status|department|modified_date';
$filtervalues = $TricomEmployee;
if (isset($view) && $view == 'myreport' && isset($id) && !empty($id)) {
    ...
    if (session_is_registered('TricomEmployee')) {
        session_unregister('TricomEmployee');
        unset($TricomEmployee);
    }  
    $filtervalues   = $TricomEmployee;
}
?>
<html>
                ...
                $("#list_of_departments").dropdownchecklist({
                 ...
                 runReport = function (format){
                    ...
                    {   
                        ...
                        $("#TricomEmployee").attr("target", "TricomEmployeeReport").submit();
                    ...
                    else if (window.opener.location.href.indexOf("BSOS/Analytics/Reports/TricomEmployee/header.php") > 0) 
                    {   
                        $("#TricomEmployee").attr("target", "TricomEmployeeReportWindow").submit();
                    }
    ...
    <body>
        <form name="TricomEmployee" id="TricomEmployee" action="storereport.php" method="post">
